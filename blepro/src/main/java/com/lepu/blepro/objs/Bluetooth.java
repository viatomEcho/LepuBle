...
public class Bluetooth implements Parcelable {
    ...
    public static final String BT_NAME_PC80B_BLE2 = "PC80B_BLE:";  // 新开发版本，已暂停
    ...
    public static final String BT_NAME_SP20 = "SP-20";  // SP-20:xxxxx / SP-20
    public static final String BT_NAME_SP20_BLE = "SP-20-BLE";
    public static final String BT_NAME_SP20_WPS = "SP-20-WPS";  // SP-20-WPS:xxxxx / SP-20-WPS
    ...
    public static final String BT_NAME_LP_BP3W = "LP-BP3W";
    public static final String BT_NAME_LP_BP3C = "LP-BP3C";
    ...
    public static final int MODEL_LP_BP3W = 118;
    public static final int MODEL_LP_BP3C = 119;
    ...
    @IntDef({MODEL_UNRECOGNIZED, MODEL_CHECKO2, MODEL_SNOREO2, MODEL_SLEEPO2, MODEL_O2RING, MODEL_OXYRING, MODEL_WEARO2, MODEL_SLEEPU, MODEL_ER1, MODEL_ER1_N,
            ...
            MODEL_LESCALE_P3, MODEL_CMI_PC303, MODEL_PF_10AW_1, MODEL_O2RING_S})
    ...
    static int getDeviceModel(String deviceName) {
        ...
        if (deviceName.contains(BT_NAME_PC60FW)) {
            ...
            if (deviceName.contains(BT_NAME_PC80B_BLE2)) {
                return MODEL_PC80B_BLE2;
            } else if (deviceName.contains(BT_NAME_PC80B_BLE)) {
            ...
            if (deviceName.contains(BT_NAME_AP20_WPS)) {
                return MODEL_AP20_WPS;
            }
            return MODEL_AP20;
            ...
            } else if (deviceName.contains(BT_NAME_SP20_WPS)) {
            ...
            if (deviceName.contains(BT_NAME_PF_10AW)) {
                ...
                } else if (deviceName.contains(BT_NAME_PF_10AW_1)) {
                    return MODEL_PF_10AW_1;
                }
        ...
        } else if (deviceName.contains(BT_NAME_PC200_BLE)) {
            return MODEL_PC200_BLE;
        } else if (deviceName.contains(BT_NAME_S5_SCALE)) {
            return MODEL_S5_SCALE;
        } else if (deviceName.contains(BT_NAME_LERES)) {
            return MODEL_LERES;
        } else if (deviceName.contains(BT_NAME_GM_300SNT)) {
            return MODEL_GM_300SNT;
        } else if (deviceName.contains(BT_NAME_OXYFIT_WPS)) {
            return MODEL_OXYFIT_WPS;
        } else if (deviceName.contains(BT_NAME_KIDS_O2_WPS)) {
            return MODEL_KIDSO2_WPS;
        } else if (deviceName.contains(BT_NAME_R20)) {
            return MODEL_R20;
        } else if (deviceName.contains(BT_NAME_R21)) {
            return MODEL_R21;
        } else if (deviceName.contains(BT_NAME_R10)) {
            return MODEL_R10;
        } else if (deviceName.contains(BT_NAME_R11)) {
            return MODEL_R11;
        } else if (deviceName.contains(BT_NAME_LP_BP3W)) {
            return MODEL_LP_BP3W;
        } else if (deviceName.contains(BT_NAME_LP_BP3C)) {
            return MODEL_LP_BP3C;
        } else if (deviceName.contains(BT_NAME_SI_PO6)) {
            return MODEL_SI_PO6;
        } else if (deviceName.contains(BT_NAME_LESCALE_P3)) {
            return MODEL_LESCALE_P3;
        } else if (deviceName.contains(BT_NAME_CMI_PC303)) {
            return MODEL_CMI_PC303;
        } else if (deviceName.contains(BT_NAME_O2RING)) {
            if (deviceName.contains(BT_NAME_O2RING_S)) {
                return MODEL_O2RING_S;
            }
            return MODEL_O2RING;
        }
    ...
    @StringDef({"", BT_NAME_O2, BT_NAME_SNO2, BT_NAME_SPO2, BT_NAME_O2RING, BT_NAME_OXYRING, BT_NAME_WEARO2, BT_NAME_SLEEPU, BT_NAME_ER1, BT_NAME_ER1_N,
            ...
            BT_NAME_CMI_PC303, BT_NAME_PF_10AW_1, BT_NAME_O2RING_S})
    @Retention(RetentionPolicy.SOURCE)
    ...
    static String getDeviceName(int model) {
        switch (model) {
            ...
            case MODEL_ECN:
                return BT_NAME_ECN;
            case MODEL_GM_300SNT:
                return BT_NAME_GM_300SNT;
            case MODEL_LP_BP3W:
                return BT_NAME_LP_BP3W;
            case MODEL_LP_BP3C:
                return BT_NAME_LP_BP3C;
            case MODEL_SI_PO6:
                return BT_NAME_SI_PO6;
            case MODEL_LESCALE_P3:
                return BT_NAME_LESCALE_P3;
            case MODEL_CMI_PC303:
                return BT_NAME_CMI_PC303;
            case MODEL_PF_10AW_1:
