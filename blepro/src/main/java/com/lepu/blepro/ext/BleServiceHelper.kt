...
import com.lepu.blepro.ext.ventilator.WifiConfig
...
class BleServiceHelper private constructor() {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as R20BleInterface).let {
                        LepuBleLog.d(tag, "it as R20BleInterface--bp2wGetWifiList")
                        it.getWifiList(0)
                    }
                }
            }
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp2wGetWifiList")
                        it.getWifiList(0)
                    }
                }
            }
    ...
    /*fun bp2wSetWifiConfig(model: Int, config: Bp2WifiConfig) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--bp2SetWifiConfig")
                        it.setWifiConfig(config)
                    }
                }
            }
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3SetWifiConfig")
                        it.setWifiConfig(config)
                    }
                }
            }
    ...
    /*fun bp2wGetWifiConfig(model: Int) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as R20BleInterface).let {
                        LepuBleLog.d(tag, "it as R20BleInterface--bp2wGetWifiConfig")
                        it.getWifiConfig(3)
                    }
                }
            }
            Bluetooth.MODEL_LP_BP3W -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp2wGetWifiConfig")
                        it.getWifiConfig(3)
                    }
                }
            }
    ...
    fun lpBp2wGetFileList(model: Int, fileType: Int) {
        ...
        when (model) {
            ...
            else -> LepuBleLog.d(tag, "lpBp2wGetFileList current model $model unsupported!!")
        }
    }
    ...
    fun er3StopEcg(model: Int) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_ER3 -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Er3BleInterface).let {
                        LepuBleLog.d(tag, "it as Er3BleInterface--er3StopEcg")
                        it.stopEcg()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "er3StopEcg current model $model unsupported!!")
        }
    }
    // Lepod
    ...
    fun echo(model: Int, data: ByteArray) {
        ...
        when (model) {
            Bluetooth.MODEL_ER1 -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Er1BleInterface).let {
                        LepuBleLog.d(tag, "it as Er1BleInterface--echo")
                        it.echo(data)
                    }
                }
            }
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--echo")
                        it.echo(data)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "echo current model $model unsupported!!")
        }
    }
    // ventilator
    fun ventilatorGetInfo(model: Int) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetInfo")
                        it.getInfo()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorGetInfo current model $model unsupported!!")
        }
    }
    fun ventilatorFactoryReset(model: Int) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetInfoventilatorFactoryReset")
                        it.factoryReset()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorFactoryReset current model $model unsupported!!")
        }
    }
    @JvmOverloads
    fun ventilatorGetFileList(model: Int, recordType: Int = 1, startTime: Long = 0) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetFileList")
                        it.getFileList(recordType, startTime)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorGetFileList current model $model unsupported!!")
        }
    }
    fun ventilatorReadFile(model: Int, fileName: String) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorReadFile")
                        it.readFile("", fileName)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorReadFile current model $model unsupported!!")
        }
    }
    /**
     * 加密通讯
    ...
    fun ventilatorDeviceBound(model: Int, bound: Boolean) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorDeviceBound")
                        it.deviceBound(bound)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorDeviceBound current model $model unsupported!!")
        }
    }
    /**
     * pin: 设备进入医生模式的密码
     ...
     */
    @JvmOverloads
    fun ventilatorGetWifiList(model: Int, deviceNum: Int = 0) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetWifiList")
                        it.getWifiList(deviceNum)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorGetWifiList current model $model unsupported!!")
        }
    }
    fun ventilatorSetWifiConfig(model: Int, config: WifiConfig) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorSetWifiConfig")
                        it.setWifiConfig(config)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorSetWifiConfig current model $model unsupported!!")
        }
    }
    /**
     ...
     * 默认3，WiFi+Server
     */
    fun ventilatorGetWifiConfig(model: Int, option: Int = 3) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetWifiConfig")
                        it.getWifiConfig(option)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorGetWifiConfig current model $model unsupported!!")
        }
    }
    fun ventilatorGetVersionInfo(model: Int) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetVersionInfo")
                        it.getVersionInfo()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorGetVersionInfo current model $model unsupported!!")
        }
    }
    fun ventilatorGetSystemSetting(model: Int) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetSystemSetting")
                        it.getSystemSetting()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorGetSystemSetting current model $model unsupported!!")
        }
    }
    fun ventilatorSetSystemSetting(model: Int, setting: com.lepu.blepro.ext.ventilator.SystemSetting) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorSetSystemSetting")
                        it.setSystemSetting(setting)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorSetSystemSetting current model $model unsupported!!")
        }
    }
    fun ventilatorGetMeasureSetting(model: Int) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetMeasureSetting")
                        it.getMeasureSetting()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorGetMeasureSetting current model $model unsupported!!")
        }
    }
    fun ventilatorSetMeasureSetting(model: Int, setting: com.lepu.blepro.ext.ventilator.MeasureSetting) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorSetMeasureSetting")
                        it.setMeasureSetting(setting)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorSetMeasureSetting current model $model unsupported!!")
        }
    }
    fun ventilatorMaskTest(model: Int, start: Boolean) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorMaskTest")
                        it.maskTest(start)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorMaskTest current model $model unsupported!!")
        }
    }
    fun ventilatorGetVentilationSetting(model: Int) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetVentilationSetting")
                        it.getVentilationSetting()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorGetVentilationSetting current model $model unsupported!!")
        }
    }
    fun ventilatorSetVentilationSetting(model: Int, setting: com.lepu.blepro.ext.ventilator.VentilationSetting) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorSetVentilationSetting")
                        it.setVentilationSetting(setting)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorSetVentilationSetting current model $model unsupported!!")
        }
    }
    fun ventilatorGetWarningSetting(model: Int) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetWarningSetting")
                        it.getWarningSetting()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorGetWarningSetting current model $model unsupported!!")
        }
    }
    fun ventilatorSetWarningSetting(model: Int, setting: com.lepu.blepro.ext.ventilator.WarningSetting) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorSetWarningSetting")
                        it.setWarningSetting(setting)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorSetWarningSetting current model $model unsupported!!")
        }
    }
    fun ventilatorVentilationSwitch(model: Int, start: Boolean) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorVentilationSwitch")
                        it.ventilationSwitch(start)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "ventilatorVentilationSwitch current model $model unsupported!!")
        }
    }
    fun ventilatorGetRtState(model: Int) {
        ...
        when (model) {
            ...
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetRtState")
                        it.getRtState()
                    }
                }
            }
    ...
    fun ventilatorGetRtParam(model: Int) {
        if (!checkService()) return
        when (model) {
            Bluetooth.MODEL_R20, Bluetooth.MODEL_R21,
            Bluetooth.MODEL_R10, Bluetooth.MODEL_R11,
            Bluetooth.MODEL_LERES -> {
                getInterface(model)?.let { it1 ->
                    (it1 as VentilatorBleInterface).let {
                        LepuBleLog.d(tag, "it as VentilatorBleInterface--ventilatorGetRtParam")
                        it.getRtParam()
                    }
                }
            }
    ...
    fun bp3GetBattery(model: Int) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3GetBattery")
                        it.getBattery()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3GetBattery current model $model unsupported!!")
        }
    }
    fun bp3GetConfig(model: Int) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3GetConfig")
                        it.getConfig()
                    }
                }
            }
    ...
    fun bp3SetConfig(model: Int, config: Bp2Config) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3SetConfig")
                        it.setConfig(config)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3SetConfig current model $model unsupported!!")
        }
    }
    fun bp3CalibrationZero(model: Int) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3CalibrationZero")
                        it.calibrationZero()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3CalibrationZero current model $model unsupported!!")
        }
    }
    fun bp3CalibrationSlope(model: Int, pressure: Int) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3CalibrationSlope")
                        it.calibrationSlope(pressure)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3CalibrationSlope current model $model unsupported!!")
        }
    }
    @JvmOverloads
    fun bp3GetRtPressure(model: Int, rate: Int = 0) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3GetRtPressure")
                        it.getRtPressure(rate)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3GetRtPressure current model $model unsupported!!")
        }
    }
    fun bp3GetRtWave(model: Int) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3GetRtWave")
                        it.getRtWave()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3GetRtWave current model $model unsupported!!")
        }
    }
    fun bp3PressureTest(model: Int, pressure: Int) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3PressureTest")
                        it.pressureTest(pressure)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3PressureTest current model $model unsupported!!")
        }
    }
    fun bp3SwitchValve(model: Int, on: Boolean) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3SwitchValve")
                        it.switchValve(on)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3SwitchValve current model $model unsupported!!")
        }
    }
    fun bp3GetCurPressure(model: Int) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3GetCurPressure")
                        it.getCurPressure()
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3GetCurPressure current model $model unsupported!!")
        }
    }
    fun bp3SwitchTestMode(model: Int, mode: Int) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3SwitchTestMode")
                        it.switchTestMode(mode)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3SwitchTestMode current model $model unsupported!!")
        }
    }
    fun bp3SwitchBpUnit(model: Int, unit: Int) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3SwitchBpUnit")
                        it.switchBpUnit(unit)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3SwitchBpUnit current model $model unsupported!!")
        }
    }
    /**
     * deviceNum: 所需设备个数
    ...
    fun bp3GetWifiList(model: Int, deviceNum: Int = 0) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3GetWifiList")
                        it.getWifiList(deviceNum)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3GetWifiList current model $model unsupported!!")
        }
    }
    fun bp3SetWifiConfig(model: Int, config: Bp2WifiConfig) {
        ...
        when (model) {
            ...
            else -> LepuBleLog.d(tag, "bp3SetWifiConfig current model $model unsupported!!")
        }
    }
    /**
     * option: Bit0:wifi Bit1:server Bit2:device
    ...
    fun bp3GetWifiConfig(model: Int, option: Int = 3) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3GetWifiConfig")
                        it.getWifiConfig(option)
                    }
                }
            }
            else -> LepuBleLog.d(tag, "bp3GetWifiConfig current model $model unsupported!!")
        }
    }
    fun bp3SwitchWifi4g(model: Int, on: Boolean) {
        ...
        when (model) {
            Bluetooth.MODEL_LP_BP3W, Bluetooth.MODEL_LP_BP3C -> {
                getInterface(model)?.let { it1 ->
                    (it1 as Bp3BleInterface).let {
                        LepuBleLog.d(tag, "it as Bp3BleInterface--bp3SwitchWifi4g")
                        it.switchWifi4g(on)
                    }
                }
            }
