...
class Constant{
    ...
    interface BluetoothConfig{
        companion object{
            ...
            const val LP_BP2W_MODEL: Int = Bluetooth.MODEL_LP_BP2W
            ...
            val SUPPORT_MODELS = intArrayOf(ER1_MODEL, DUOEK_MODEL, ER2_MODEL, PC80B_MODEL, BP2_MODEL,
                ...
                LP_BP2W_MODEL, TV221U_MODEL, AOJ20A_MODEL, BABYO2N_MODEL, CHECKO2_MODEL, O2M_MODEL,
                ...
                LP_BP3W_MODEL, LP_BP3C_MODEL, SI_PO6_MODEL, LESCALE_P3_MODEL, CMI_PC303_MODEL
            )
